...
GitHub CLI המקומי עדיין אינו מחובר, אבל Git דרך Credential Manager והחיבור של Codex ל־GitHub פעילים. פעולות שאינן נתמכות בחיבור מבוצעות בממשק GitHub המחובר.
