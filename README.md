...
הפרויקט נמצא בשלב 1: הקמת שלד האפליקציה והכנת ה־Vertical Slice הראשון. שלד ה־Next.js PWA מפותח במסגרת Issue #3. המצב המדויק והמשימה הפעילה מתועדים ב־[docs/STATUS.md](docs/STATUS.md).
